...
class _HomeScreenState extends State<HomeScreen> {
  ...
  static String API_KEY = '474f2e8d737f4c228d5180537240305';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor:_constants.darkColor,
      body:
      Container(
        width: size.width,
        height: size.height,
                        ...
                        return Container(
                          ...
                          decoration: BoxDecoration(
                              color: currentHour == forecastHour
                                  ? _constants.lightColor.withOpacity(0.7)
                                  : _constants.primaryColor.withOpacity(0.6),
                              borderRadius:
